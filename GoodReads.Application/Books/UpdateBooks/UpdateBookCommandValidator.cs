...
namespace GoodReads.Application.Books.UpdateBook;
...
public class UpdateBookCommandValidator : AbstractValidator<UpdateBookCommand>
{
    public UpdateBookCommandValidator()
    {
        ...
        RuleFor(r => r.Description)
            ...
            .EmailAddress().WithMessage("Description is invalid")
        ...
        RuleFor(r => r.Author)
            ...
            .EmailAddress().WithMessage("Author is invalid")
        ...
        RuleFor(r => r.Publisher)
            ...
            .EmailAddress().WithMessage("Publisher is invalid")
        ...
        RuleFor(r => r.CoverImage)
            ...
            .EmailAddress().WithMessage("Cover image is invalid")
